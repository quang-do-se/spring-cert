...
`@Autowired` cannot be used to autowire primitive type.
  - However, it works for any Object type like `String` or `Integer`.
  - `@Value` is a better way to inject these primitive types.
