...
class NamedParameterJdbcPersonRepoTest {
    ...
    void testUpdatePassword() {
        jdbcNamedPersonRepo.updatePassword(1L, "Hello");

        jdbcNamedPersonRepo.findById(1L).ifPresentOrElse(
                p -> assertEquals(p.getPassword(), "Hello"),
                Assertions::fail
        );
    }
    ...
    void testDeleteByIdPositive() {
        jdbcNamedPersonRepo.deleteById(1L);
        assertThrows(EmptyResultDataAccessException.class, () -> jdbcNamedPersonRepo.findById(1L));
    }
}
